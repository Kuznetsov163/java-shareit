...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findFirstByItem_IdAndBooker_IdAndEndIsBeforeAndStatus(Long itemId, Long userId, LocalDateTime end, BookingStatus status);
    ...
    Booking findFirstByItem_IdAndStartAfterAndStatusNotOrderByStart(Long itemId, LocalDateTime start, BookingStatus status);
}
